...
int TIFFInitCCITTFax4 ( TIFF * tif )
{
   ...
   /* FAX3_NOEOL causes the regular G3 decompression code to not skip to
    * the EOL mark at the end of a row (during normal decoding).
    * FAX3_CLASSF suppresses RTC generation at the end of an image. */
