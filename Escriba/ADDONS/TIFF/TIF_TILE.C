...
TIFFVTileSize ( TIFF * tif, uint32 nrows )
{
   ...
   if ( td->td_planarconfig == PLANARCONFIG_CONTIG &&
       ...
       * HorizontalSampling*VerticalSampling Y values. Must also roundup
       * width and height when calculating since images that are not a
       * multiple of the horizontal/vertical subsampling area include
